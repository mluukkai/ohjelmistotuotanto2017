...
* kirjaudu [Codeconviin](https://codecov.io) (GitHub signin)
* lisää repositorio Codeconviin alaisuuteen valitsemalla repositorio listalta 

![](https://raw.githubusercontent.com/mluukkai/ohtuprojekti2017/master/images/lh1-7a.png)
...
Saat Codeconv:in tarkkailemaan projektisi koodikattavuutta lisäämällä tiedoston _build.gradle_ loppuun seuraava:
...
Kun seuraavan kerran pushaamme koodin Githubiin, ilmestyy Codeconv:iin koodin testikattavuusraportti:

![](https://raw.githubusercontent.com/mluukkai/ohtuprojekti2017/master/images/lh1-8a.png)

Klikkaailemalla kohdasta _Files_ tiedostojen nimiä, pääset katsomaan yksittäisten luokkien testauksen kattamat rivit:

![](https://raw.githubusercontent.com/mluukkai/ohtuprojekti2017/master/images/lh1-9a.png)

Käytännössä pyydämme Travisia suorittamaan onnistuneen buildin (eli komennon <code>gradle check</code>) jälkeen gradle-komennon, joka ensin suorittaa testien kattavuusanalyysin JaCoCo:lla ja sen jälkeen lähettää tiedot Codeconviin.

Pushaa nyt muutokset GitHubiin ja seuraa _sekä_ Travis-buildin lokia, että repositorion Codeconv-sivua.
...
![](https://raw.githubusercontent.com/mluukkai/ohtuprojekti2017/master/images/lh1-10a.png)

Huomaa, että Travisin ja Codeconv badget eivät päivity täysin reaaliajassa. Eli vaikka projektin testikattavuus nousisi, kestää hetken, ennen kuin badge näyttää tuoreen tilanteen.

## 13. riippuvuuksien injektointi osa 1
...
* hae esimerkkiprojekti kurssirepositorion hakemistosta [koodi/viikko1/RiippuvuuksienInjektointi](https://github.com/mluukkai/ohjelmistotuotanto2017/tree/master/koodi/viikko1/RiippuvuuksienInjektointi1) ja kokeile että se toimii
...
## 14. riippuvuuksien injektointi osa 2: NHL-tilastot
...
## 15.  NHLStatistics-ohjelman yksikkötestaus
...
## 16. Forkaa repositorio https://github.com/mluukkai/ohjelmistotuotanto2017
...
* saat näin oman "forkatun" kopion repositoriosta ohjelmistotuotanto017
...
* Kirjaa tekemäsi tehtävät [tänne](http://ohtustats-syksy2017.herokuapp.com) 
