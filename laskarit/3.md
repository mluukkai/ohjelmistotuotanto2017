...
Esim. tälläisissä tapauksissa on mahdollisuus suorittaa parsiminen hyödyntämällä gsonin luokkaa: _JsonParser_. Importtaa JsonParser ja luokka _JsonObject_ koodisi:
...
## 10. Uuden käyttäjän rekisteröitymisen testit
