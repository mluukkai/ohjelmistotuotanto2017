# KESKEN. ÄLÄ TEE MUITA KUIN VALMIINA OLEVIA

<em>tehtävät 1-9 valmiina</em>
...
Käytännössä syynä on se, että selenium yrittää klikata linkkiä "liian aikaisin". Ongelma on mahdollista kiertää klikkaamalla poikkeuksen tapahtuessa linkkiä uudelleen. Jos törmäät ongelmaan, voit ottaa koodiisi seuraavassa olevan apumetodin, joka suorittaa sopivan määrän uudelleenklikkauksia:
...
```
Lisää asiasta esim.
[täälläkkeli](https://stackoverflow.com/questions/12967541/how-to-avoid-staleelementreferenceexception-in-selenium)
