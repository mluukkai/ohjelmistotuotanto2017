...
Omat palautukset palauttava sivu on __https://studies.cs.helsinki.fi/ohtustats/students/011120775/submissions__ (vaihda 011120775 omaksi opiskelijanumeroksesi). Palvelin palauttaa tietosi [json-muodossa](http://en.wikipedia.org/wiki/JSON)
...
opiskelijanumero: 011120775
 ...
 viikko 1: 
   ...
   viikolla yhteensä 96 palautusta
 viikko 2: 
   tehtyjä tehtäviä yhteensä: 6 (maksimi 8), aikaa kului 4 tuntia, tehdyt tehtävät: 1 2 3 6 7 8  
   viikolla yhteensä 4 palautusta

yhteensä: 15 tehtävää 7 tuntia
kurssilla yhteensä 100 palautusta
</pre>
