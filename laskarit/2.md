...
* tehtävät x ja y tehdään paikalliseen repositorioon, eli ne eivät näy palautuksessa mitenkään
...
## 5. lisää git:iä: branchit ja GitHub
...
## 6. epäajantasaisen kopion pushaaminen
...
## 7. riippuvuuksien injektointi osa 3: Verkkokauppa
...
## 8. riippuvuuksien injektointi osa 4: ei enää singletoneja verkkokaupassa
...
## 9 Spring osa 1: Verkkokauppa siistiksi
...
## 10. Spring osa 2: Verkkokauppa siistiksi annotaatioilla
...
* Kirjaa tekemäsi tehtävät osoitteeseen http://studies.cs.helsinki.fi/ohtustats
