...
Tehtävistä valmiina tällä hetkellä 1-3
...
https://www.codacy.com on palvelu, jonka avulla voimme suorittaa helposti staattista analyysiä githubissa olevalle koodille. Java-koodille codacy tekee tarkastukset checksylen lisäksi [pmd](https://pmd.github.io):llä. 

Mene codacyn sivulle ja klikkaa _signup with github_. Lisää edellisen tehtävän koodin sisältäv repositoriosi codacyn tarkkailtavaksi:
...
Odota että sen analyysi valmistuu katso miltä "dashboard" näyttää.
...
- tehtävä, jossa selviää että staging-alue ei kuulu mihinkään branchiin
  tavara menee branchiin vasta committoidessa

## 6. lisää git:iä: konflikti!
...
## 7. lisää git:iä: branchit ja GitHub
